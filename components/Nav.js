      ...
      <Box w="100vw" position="fixed" top="0" right="0" bg="white" left="0">
        <Flex>
          <Box p="2" h="45px" width="300px" bg="transparent">
            ...
            <Link href="https://shop.hldtru.com/collections/all" target="_blank" rel="norefferer" passHref>
              <Button size="sm" h="22px" pl="3" pr="3" mr="1" border="0px" variant="outline" borderRadius="md">
                Webstore
              </Button>
            </Link>
          ...
          <Box p="2" h="45px" w="100px" align="right" bg="transparent">
            <Link href="https://shop.hldtru.com/cart" target="_blank" rel="norefferer" passHref>
              <Button size="sm" h="22px" pl="3" pr="3" mr="1" border="0px" variant="outline" borderRadius="md">
                Cart
              </Button>
            </Link>
