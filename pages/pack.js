      ...
      <ChakraProvider>
        ...
        <Container pt="100" pb="100" maxW="container.md">
          ...
          <Text fontSize="sm">
            ...
            to the "Days of Truth" Shorts specifically, and cannot be paired with any other items.
          </Text>

          <Skeleton height="60px" isLoaded />

          <Text fontSize="xs">For questions or concerns, please contact sales@hldtru.com</Text>
